# markspec-ide — development

Contributor and release notes for the
[MarkSpec](https://github.com/driftsys/markspec) VS Code extension. User-facing
documentation lives in [README.md](README.md) (the marketplace overview).
